...
agent_config = {'gamma': 0.9,              # the discount factor
                ...
                'epsilon_burnin': 100}       # set up the agent config
...
for episode in range(1000):
    ...
    print(episode, ":", score, "in", turns, "turns")
    # print(episode, ":")
    # # Print all weights of the Q-Network
    # for name, param in agent.q_network.state_dict().items():
